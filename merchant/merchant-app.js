(() => {
  ...
  async function store() {
    ...
    $('#save').onsubmit = async event => {
      ...
      try {
        await invokeEdge({ action: 'merchant_update_store', data: { name: $('#name').value.trim(), description: $('#description').value.trim(), phone: $('#phone').value.trim(), eta: $('#eta').value.trim(), ...draftMedia } });
