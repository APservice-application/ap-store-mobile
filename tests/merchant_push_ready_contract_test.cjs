...
const sw = fs.readFileSync('merchant/firebase-messaging-sw.js', 'utf8');
const boot = fs.readFileSync('merchant/merchant-app.js', 'utf8');
...
console.log('merchant push ready contract: PASS');
